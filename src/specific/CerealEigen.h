#ifndef SEMANTIC_TYPES_TEST_PROJECT_CEREALEIGEN_H
#define SEMANTIC_TYPES_TEST_PROJECT_CEREALEIGEN_H
...
namespace cereal {
    ...
    inline
    typename std::enable_if<!cereal::traits::is_output_serializable<cereal::BinaryData<_Scalar>, Archive>::value, void>::type
    save(Archive& ar, const Eigen::Matrix<_Scalar, 3, 1, _Options, _MaxRows, _MaxCols>& m)
    {
        ar(cereal::make_nvp("x", m(0,0)));
        ar(cereal::make_nvp("y", m(1,0)));
        ar(cereal::make_nvp("z", m(2,0)));
...
#endif //SEMANTIC_TYPES_TEST_PROJECT_CEREALEIGEN_H
